export default function WhySection() {
  return (
    <section className="bg-[#F4F8FA] dark:bg-[#121212] py-20 px-4 md:px-8 lg:px-8 relative transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          <div className="lg:col-span-3 flex flex-col pt-8 pr-4" data-aos="fade-right">
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="px-5 py-2 bg-[#21282C] dark:bg-white text-white dark:text-[#1D1D24] rounded-full text-sm font-medium">About us</span>
            </div>
            <h2 className="text-4xl md:text-[44px] font-bold mb-6 text-[#1A202C] dark:text-white leading-tight">Why choose us</h2>
          ...
          <div className="lg:col-span-3 flex flex-col gap-10 h-full" data-aos="fade-up" data-aos-delay="200">
            <div className="w-full relative bg-[#E1E5DF] h-1/2 min-h-[200px] overflow-hidden border border-gray-100/50 dark:border-gray-800">
            ...
            <div className="bg-[#21282C] dark:bg-[#1A1A1A] p-6 lg:p-8 flex-1 flex flex-col justify-center border dark:border-gray-800">
                ...
                <div className="flex -space-x-3">
                    <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=100&auto=format&fit=crop" alt="User" className="w-10 h-10 rounded-full border-2 border-[#21282C] dark:border-[#1A1A1A] object-cover" />
                    <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=100&auto=format&fit=crop" alt="User" className="w-10 h-10 rounded-full border-2 border-[#21282C] dark:border-[#1A1A1A] object-cover" />
                    <img src="https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?q=80&w=100&auto=format&fit=crop" alt="User" className="w-10 h-10 rounded-full border-2 border-[#21282C] dark:border-[#1A1A1A] object-cover" />
                    <img src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?q=80&w=100&auto=format&fit=crop" alt="User" className="w-10 h-10 rounded-full border-2 border-[#21282C] dark:border-[#1A1A1A] object-cover" />
                </div>
            </div>
          </div>

          <div className="lg:col-span-3" data-aos="fade-up" data-aos-delay="300">
            <div className="border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1D1D24] p-8 lg:p-10 h-full flex flex-col justify-between relative overflow-hidden">
              <div className="absolute inset-0 pointer-events-none stroke-gray-200 dark:stroke-gray-800">
              ...
              <div className="relative z-10 pt-2">
                  <h3 className="text-4xl lg:text-[42px] font-bold text-[#1A202C] dark:text-white mb-2 leading-none">238+</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Brands served worldwide</p>
              </div>
              
              <div className="relative z-10 pb-2">
                  <h4 className="text-[32px] font-bold text-[#1A202C] dark:text-white mb-4">Studiova.</h4>
