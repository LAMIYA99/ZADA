export default function MeetSection() {
    ...
    return (
        <section className="bg-white dark:bg-[#1D1D24] py-20 px-4 md:px-8 lg:px-10 relative transition-colors duration-300">
            <div className="mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-start">
                    <div className="lg:col-span-4 flex items-center gap-4">
                        ...
                        <span className="px-5 py-2 bg-[#21282C] dark:bg-white text-white dark:text-[#1D1D24] rounded-full text-sm font-medium">The team</span>
                    </div>
                    <div className="lg:col-span-6 lg:col-start-5" data-aos="fade-up">
                        <h2 className="text-4xl md:text-[40px] font-semibold mb-4 text-[#1A202C] dark:text-white">Meet our team</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {team.map((member, index) => (
                        <div key={index} className="group cursor-pointer mx-auto w-full max-w-[388px]" data-aos="fade-up" data-aos-delay={index * 100}>
                            <div className="relative overflow-hidden mb-5 bg-gray-100 dark:bg-gray-800 w-full h-[465px]">
                                <img
                                    src={member.image}
                                    alt={member.name}
                            ...
                            <div>
                                <h3 className="text-[22px] font-bold text-[#1A202C] dark:text-white mb-1">{member.name}</h3>
